...
/* Each table is given a descriptive name, The employee table contains records of employees who are given different tasks in this water project
The visit table contains records of each visit made to each water source, the time spent in queue was recorded.
